...
class TestSPACommands(unittest.TestCase):
    ...
    def test_fsc(self):
        ...
        numpy.testing.assert_allclose(df.fsc_FC_full, [ 0.999384,  0.982716,  0.94365 ,  0.923566,  0.91484 ,  0.913189,
                                      ...
                                      rtol=1e-5)
        numpy.testing.assert_allclose(df.fsc_half, [0.99998 , 0.999857, 0.999549, 0.998618, 0.998465, 0.998222,
