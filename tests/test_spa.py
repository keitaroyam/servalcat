...
class TestSPACommands(unittest.TestCase):
    ...
    def test_fsc(self):
        ...
        numpy.testing.assert_allclose(df.fsc_FC_full,
                                      [0.999111,  0.979994,  0.957389,  0.934734,  0.943532,  0.935473,
                                       0.922484,  0.893307,  0.905921,  0.892223,  0.903067,  0.919698,
                                       0.917518,  0.92516 ,  0.941235,  0.951891,  0.964544,  0.968748,
                                       0.96509 ,  0.962433,  0.960395,  0.960702,  0.958297,  0.956205,
                                       0.943905,  0.937358,  0.93694 ,  0.934549,  0.922514,  0.887436,
                                       0.857522,  0.822146,  0.798532,  0.774824,  0.732929,  0.658742,
                                       0.62155 ,  0.598483,  0.552552,  0.507689,  0.4282  ,  0.302279,
                                       0.288362,  0.233319,  0.165043,  0.136085,  0.095075,  0.064365,
                                       0.028783,  0.011409, -0.003449,  0.022285,  0.029825],
                                      rtol=1e-4)
