...
class XtalTests(unittest.TestCase):
    ...
    def test_sigmaa(self):
        ...
        numpy.testing.assert_allclose(hkldata.binned_df["ml"].D0,
                                      [0.829502, 0.992942, 1.033477, 0.985832, 1.015752, 1.037033,
                                       1.027884, 1.025767, 0.98953 , 0.973503],
                                      rtol=1e-2)
        ...
        numpy.testing.assert_allclose(hkldata.binned_df["ml"].S,
                                      [90.148956,  98.349528,  67.327155,  86.963999,  72.103566,
                                       109.583661, 107.490489,  98.948249,  28.173728,  41.828306],
                                      rtol=1e-2)
