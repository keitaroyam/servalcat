...
The required GEMMI version is now [v0.5.2](https://github.com/project-gemmi/gemmi/releases/tag/v0.5.2). Please update GEMMI as well if it is old (it should be done by pip).
