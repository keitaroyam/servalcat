...
The required GEMMI version is now [v0.6.3](https://github.com/project-gemmi/gemmi/releases/tag/v0.6.3). It may not work with the latest gemmi code from the github. The policy is in the main branch I only push the code that works with the latest package of GEMMI.
